...
#images
background = pygame.image.load("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\background.png").convert()
background = pygame.transform.scale2x(background)

floor = pygame.image.load("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\floor.png").convert()
floor = pygame.transform.scale2x(floor)
floor_x_pos = 0

butterfly_surface=pygame.Surface((10,10))
butterfly_surface=pygame.image.load("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\butter_fly.png").convert_alpha()
...
pipe_surface = pygame.image.load("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\pipe.png").convert()
pipe_surface = pygame.transform.scale2x(pipe_surface)
pipe_surface1 = pygame.image.load("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\pipe1.png").convert()
...
#sounds
#bg_music = pygame.mixer.Sound("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\sound_sfx_die.wav")
flap_sound = pygame.mixer.Sound("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\sound_sfx_hit.wav")
score_sound = pygame.mixer.Sound("C:\\Users\\USER_\Downloads\\fluppy-bird_game\\sound_sfx_point.wav")
score_sound_countdown = 300

#start the game
start_surface = pygame.transform.scale2x(pygame.image.load("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\press_to_start1.png")).convert_alpha()
start_rect = start_surface.get_rect(center = (512,230))

#game over
game_over_surface = pygame.transform.scale2x(pygame.image.load("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\game_over.png").convert_alpha())
game_over_rect = game_over_surface.get_rect(center = (512,100))

#restart the game
restart_surface = pygame.transform.scale2x(pygame.image.load("C:\\Users\\USER\\Downloads\\fluppy-bird_game\\press_to_start1.png").convert_alpha())
